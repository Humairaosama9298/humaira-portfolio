...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Humaira Osama",
    },
    {
      fieldName: "Phone",
      fieldValue: "+92 319 4051374",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "humairaosama6@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    ...
    {
      company: "Quranic Educare Hub Academy",
      position: "UI/UX Designer",
      duration: "2021 - 2023",
    },
    {
      company: "Terra Verda CO.",
      position: "Frontend Developer",
...
const education = {
  ...
  items: [
    ...
    {
      institude: "Sir Syed Girls Collage",
      degree: "Intermidiate",
      field: "Home Economics",
      year: "2010-2012",
    },
    {
      institude: "Karachi University",
      degree: "B.A",
      field: "Homa Economics",
      year: "2014-2018",
    },
    {
      institude: "Governor House",
      degree: "Web 3 and Metaverse",
      field: "IT Course",
      year: "2024-Continue",
    },
  ],
...
export default function Resume() {
  return (
    <motion.div
      ...
      animate={{
        opacity: 1,
        transition: { delay: 1.4, duartion: 0.2, ease: "easeIn" },
      }}
                    ...
                    {education.items.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <p className="text-white/60 -mt-5">{item.field}</p>
